#ifndef MOSS_MODEL_LOADER_HPP
#define MOSS_MODEL_LOADER_HPP
...
private:
    ...
    struct ggml_context*      spacemit_ctx_   = nullptr;  // repacked quantized matmul weights
    ggml_backend_buffer_t     backend_buffer_ = nullptr;  // owns the ordinary weight data
    ggml_backend_buffer_t     promote_buffer_ = nullptr;  // owns promoted weight data
    ggml_backend_buffer_t     spacemit_buffer_= nullptr;  // owns SpaceMIT-repacked weights
